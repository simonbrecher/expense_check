...
INSERT INTO `invoice_head` (`id`, `user_id`, `card_id`, `order_id`, `d_issue`, `counter_account_number`, `counter_account_bank_code`, `var_symbol`, `is_paidbybank`, `is_paidbycard`, `is_paidbycash`) VALUES
(1,	1,	1,	NULL,	'2021-01-26',	'0',	'',	'2200',	0,	1,	0),
(2,	1,	NULL,	NULL,	'2001-01-10',	'0',	'',	'',	0,	0,	1),
(24,	1,	NULL,	NULL,	'2012-10-20',	'',	'',	'',	0,	0,	1);
...
(13,	24,	1,	NULL,	480.00,	'prací prášek'),
(14,	24,	2,	NULL,	20.00,	'mlsy');
