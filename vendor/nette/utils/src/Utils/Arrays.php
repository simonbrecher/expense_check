...
class Arrays
{
	...
	/**
	 * Tests whether at least one element in the array passes the blog implemented by the
	...
	/**
	 * Tests whether all elements in the array pass the blog implemented by the provided function,
